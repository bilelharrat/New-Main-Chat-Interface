...
import { ArrowRight, FileText, MessageSquare, Sliders, Maximize2, Minimize2, StickyNote, Copy, Pencil, Clock, Clipboard, CheckSquare, Download, ChevronLeft, ChevronRight, User, X, Search, Inbox, GripVertical, Settings, PanelLeftClose, PanelRightClose, Sun, Moon, Bot, Upload, Filter, Star, Sparkles } from 'lucide-react';
...
<body>
  ...
  const handleFileUpload = (file) => {
    ...
    if (file) {
      ...
      console.log('✅ File ready for hierarchical summarization');
    }
  };
    ...
    return (
      <div
        ...
        >
          ...
          {/* Elegant Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100/60 dark:border-gray-800/60 bg-gradient-to-r from-gray-50/80 to-white/80 dark:from-gray-900/80 dark:to-gray-800/80 backdrop-blur-sm">
            {!writeCollapsed && (
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-gradient-to-r from-apple-blue-500 to-apple-purple-500 rounded-full animate-pulse"></div>
                <span className="font-light text-gray-900 dark:text-white tracking-wide text-sm">Write</span>
                {/* Layout Toggle Button */}
                <button
                  onClick={togglePanelLayout}
                  className="ml-3 px-3 py-1.5 text-xs bg-gradient-to-r from-gray-100/80 to-gray-200/80 dark:from-gray-700/80 dark:to-gray-600/80 hover:from-gray-200/80 hover:to-gray-300/80 dark:hover:from-gray-600/80 dark:hover:to-gray-500/80 text-gray-700 dark:text-gray-300 rounded-lg font-medium transition-all duration-200 hover:scale-105 border border-gray-200/60 dark:border-gray-600/60"
                  ...
                  <div className="relative">
                    ...
                    {showFormatInput && (
                      <div className="absolute right-0 mt-3 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-2xl shadow-2xl p-4 z-50 flex items-center gap-3 animate-in slide-in-from-top-2">
                        <input
                          type="text"
                          className="px-3 py-2 rounded-xl border border-gray-200/60 dark:border-gray-700/60 bg-white/80 dark:bg-gray-800/80 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-apple-blue-500/30 focus:border-apple-blue-500 transition-all duration-200"
                        ...
                        />
                        <button
                          className="text-sm px-4 py-2 rounded-xl bg-gradient-to-r from-apple-blue-500 to-apple-blue-500/80 text-white font-medium hover:from-apple-blue-600 hover:to-apple-blue-600/80 transition-all duration-200 hover:scale-105 shadow-lg"
              ...
              {showTodos.write && (
                <div className="mx-6 mb-4 p-5 bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-800/80 dark:to-gray-700/80 rounded-2xl border border-gray-200/40 dark:border-gray-700/40 backdrop-blur-sm shadow-lg">
                  ...
                  <div className="flex gap-3 mb-4">
                    ...
                    />
                    <button
                      className="px-4 py-3 text-sm bg-gradient-to-r from-apple-blue-500 to-apple-blue-500/80 text-white rounded-xl hover:from-apple-blue-600 hover:to-apple-blue-600/80 transition-all duration-200 hover:scale-105 shadow-lg font-medium"
                      onClick={(e) => {
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100/60 dark:border-gray-800/60 bg-gradient-to-r from-gray-50/80 to-white/80 dark:from-gray-900/80 dark:to-gray-800/80 backdrop-blur-sm">
          {!notesCollapsed && (
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-gradient-to-r from-apple-green-500 to-apple-blue-500 rounded-full animate-pulse"></div>
              <span className="font-light text-gray-900 dark:text-white tracking-wide text-sm">Notes</span>
              {/* Layout Toggle Button */}
              <button
                onClick={togglePanelLayout}
                className="ml-3 px-3 py-1.5 text-xs bg-gradient-to-r from-gray-100/80 to-gray-200/80 dark:from-gray-700/80 dark:to-gray-600/80 hover:from-gray-200/80 hover:to-gray-300/80 dark:hover:from-gray-600/80 dark:hover:to-gray-500/80 text-gray-700 dark:text-gray-300 rounded-lg font-medium transition-all duration-200 hover:scale-105 border border-gray-200/60 dark:border-gray-600/60"
            ...
            {showTodos.notes && (
              <div className="mx-6 mb-4 p-5 bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-800/80 dark:to-gray-700/80 rounded-2xl border border-gray-200/40 dark:border-gray-700/40 backdrop-blur-sm shadow-lg">
                ...
                <div className="flex gap-3 mb-4">
                  ...
                  />
                  <button
                    className="px-4 py-3 text-sm bg-gradient-to-r from-apple-green-500 to-apple-blue-500 text-white rounded-xl hover:from-apple-green-600 hover:to-apple-blue-600 transition-all duration-200 hover:scale-105 shadow-lg font-medium"
                    onClick={(e) => {
                      const input = e.target.previousElementSibling;
                      if (input.value.trim()) {
                        ...
                        <ReactMarkdown
                          components={{
                            ...
                            code: ({node, inline, ...props}) => inline ? 
                              ...
                              <code className="block bg-gray-100 dark:bg-gray-700 p-3 rounded text-sm font-mono overflow-x-auto" {...props} />,
                            pre: ({node, ...props}) => <pre className="bg-gray-100 dark:bg-gray-700 p-3 rounded text-sm font-mono overflow-x-auto mb-2" {...props} />,
                              ...
                              <>
                                {citedMessageIndices.includes(idx) && (
                                  <div className="absolute top-2 right-12 text-accent z-10" title="Cited in Notes">
                                    ...
                                    <button
                                      type="button"
                                    className="absolute top-1.5 right-1.5 bg-black/5 dark:bg-white/5 text-gray-500 dark:text-gray-400 rounded-full p-1 hover:bg-black/10 dark:hover:bg-white/10 transition-all duration-200 focus-ring"
                            ...
                            {msg.role === 'user' ? (
                              ...
                              <div className="flex justify-center w-full">
                                ...
                                {Object.entries(multipleResponses[idx].allResponses).map(([modelName, content]) => (
                                  ...
                                  >
                                    {/* Chat Bubble - Exactly like the reference image */}
                                  ...
                                  : (
                                        <ReactMarkdown
                                          components={{
                                            ...
                                            h2: ({node, ...props}) => <h2 className="text-lg font-bold mb-2 mt-4 first:mt-0 text-gradient-primary" {...props} />,
                                            h3: ({node, ...props}) => <h3 className="text-base font-bold mb-2 mt-3 first:mt-0" {...props} />,
                                            p: ({node, ...props}) => <p className="mb-2 last:mb-0" {...props} />,
                                            ul: ({node, ...props}) => <ul className="list-disc list-inside mb-2 space-y-1" {...props} />,
                                            ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-2 space-y-1" {...props} />,
                            ...
                            <div className="mt-2 flex justify-between items-center w-full text-xs text-gray-500 dark:text-gray-400">
                                <div className="flex items-center gap-2">
                                  ...
                                  {backlinks[idx] && backlinks[idx].length > 0 && (
                                    <div className="text-accent bg-gradient-to-r from-apple-green-500 to-apple-blue-500 text-white rounded-full px-3 py-1 shadow-sm">
        ...
        <div className="mt-4">
          ...
          >
            ...
            value={prompt}
                  ...
                  className={`w-full input-modern ${fullscreen ? 'min-h-[200px] max-h-[400px]' : 'min-h-[24px] max-h-[160px]'} resize-none bg-transparent text-gray-900 dark:text-white px-4 py-2 focus:outline-none transition-all duration-200 focus-ring`}
              ...
              <button 
                type="submit" 
                className="btn-primary p-2 rounded-full shadow-apple flex items-center justify-center h-10 w-10 self-end disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-apple-hover transition-all duration-200"
                disabled={!prompt.trim()}
              >
                {isProcessing ? (
            ...
            {isTyping && (
              <div className="flex items-center gap-3 p-3 mt-2 bg-gray-50 dark:bg-gray-800/50 rounded-xl animate-fade-in">
                <div className="flex space-x-1">
                  <div className="w-2 h-2 bg-gradient-to-r from-apple-green-500 to-apple-blue-500 rounded-full animate-blink" style={{ animationDelay: '0ms' }}></div>
                  <div className="w-2 h-2 bg-gradient-to-r from-apple-blue-500 to-apple-purple-500 rounded-full animate-blink" style={{ animationDelay: '150ms' }}></div>
                  <div className="w-2 h-2 bg-gradient-to-r from-apple-purple-500 to-apple-orange-500 rounded-full animate-blink" style={{ animationDelay: '300ms' }}></div>
                </div>
            ...
            <button
              type="button"
                  className={`flex items-center gap-2 text-sm transition px-3 py-1.5 rounded-xl ${
                    selectedMode === "Coding" 
                      ? 'text-white bg-gradient-to-r from-apple-red-500 to-apple-orange-500 shadow-sm' 
                      : isHierarchicalSummarizerMode(selectedMode)
                      ? 'text-white bg-gradient-to-r from-apple-blue-500 to-apple-purple-500 shadow-sm'
          ...
          <button 
            type="button" 
                  className="flex items-center gap-1.5 text-sm transition px-3 py-1.5 rounded-xl text-white bg-gradient-to-r from-apple-green-500 to-apple-blue-500 shadow-sm"
          ...
          >
            <Upload size={14}/>
              ...
              <button
                type="button"
                className={`flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-xl transition ${writeOpen ? 'text-white bg-gradient-to-r from-apple-blue-500 to-apple-purple-500 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              ...
              <button
                type="button"
                className={`flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-xl transition ${notesOpen && !writeOpen ? 'text-white bg-gradient-to-r from-apple-green-500 to-apple-blue-500 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              ...
              <button
                type="button"
                  className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-xl text-gray-500 dark:text-gray-400 hover:text-accent dark:hover:text-accent-foreground transition hover:bg-gray-100 dark:hover:bg-gray-700"
        ...
        <div className="flex items-center gap-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-3 py-2 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs text-gray-600 dark:text-gray-400">
              {backendStatus === 'connected' ? 'Backend' :
